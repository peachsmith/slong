...
INCLUDE_DIR=/I$(CRUMBS_HOME)\include /I$(SDL2_HOME)\include /I"$(MARIADB_HOME)\include" /I.
LINK_DIR=/LIBPATH:"$(CRUMBS_HOME)\lib" /LIBPATH:"$(SDL2_HOME)\lib" /LIBPATH:"$(MARIADB_HOME)\lib"

CFLAGS=/W3 /WX
LIBS="libmariadb.lib" "crumbs.lib" "SDL2.lib" "SDL2main.lib" "SDL2_ttf.lib" "SDL2_image.lib" "SDL2_mixer.lib" "kernel32.lib" "user32.lib" "shell32.lib"
